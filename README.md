...
- **Foreach Stage Resolution** — 🎯 Dynamic resolution of the active DVC `foreach` variant using real-time analysis of the DVC `rwlock` file, with full support for global `vars` interpolation.
